...
func (*UserApps) Descriptor() ([]byte, []int) {
	return fileDescriptor_appsinstalled_6b02049e43d170f4, []int{0}
}
...
func (dst *UserApps) XXX_Merge(src proto.Message) {
	xxx_messageInfo_UserApps.Merge(dst, src)
}
...
func init() { proto.RegisterFile("appsinstalled.proto", fileDescriptor_appsinstalled_6b02049e43d170f4) }

var fileDescriptor_appsinstalled_6b02049e43d170f4 = []byte{
